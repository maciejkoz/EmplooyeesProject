...
public class EmployeeController {
    ...
    private void addEmployeeToDatabase(Employees employee) {
        try {
    ...
    private void updateEmployeeInDatabase(Employees employee) {
        try {
            hibernateDao.updateEntity(employee);
        } catch (NullPointerException e) {
            e.printStackTrace();
        }
    }

    private void deleteEmployeeFromDatabase(Employees employee) {
        try {
